...
export class LTVModel {
   ...
   */
  static predictLifetimeValue(customerStats: CustomerStats): number {
   ...
   * Get LTV tier
   */
  static getLTVTier(ltv: number): string {
    if (ltv < 50) return "bronze";
   ...
   */
  static projectFutureLTV(customerStats: CustomerStats, months: number = 12): number {

...
import { startCampaignScheduler } from "./jobs/campaignScheduler.js";
import { startPrinterQueueWorker } from "./jobs/printerQueueWorker.js";
import { startPrinterDiscoveryWorker } from "./jobs/printerDiscoveryWorker.js";
import { startPrinterAutoscaleWorker } from "./jobs/printerAutoscaleWorker.js";
import { startPrinterSyncWorker } from "./jobs/printerCloudSyncWorker.js";
import { startPrinterSLAWorker } from "./jobs/printerSLAWorker.js";
...
app.use((err: Error, req: Request, res: Response, _next: NextFunction) => {
  ...
  try { errorsTotal.inc(1); } catch (e) { /* ignore metric errors */ }

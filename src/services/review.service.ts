...
export class ReviewService {
  async submitReview(customerId: string, data: any): Promise<any> {
  ...
  async updateReview(customerId: string, reviewId: string, data: any): Promise<any> {
  ...
  async deleteReview(customerId: string, reviewId: string): Promise<any> {
    const review = await prisma.review.findUnique({
      where: { id: reviewId }
    });

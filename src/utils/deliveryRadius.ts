...
export async function isAddressWithinDeliveryRadius(addressId: string, branchId: string): Promise<boolean> {
  ...
  haversineDistanceKm(address.lat, address.lng, (branch as any).lat, (branch as any).lng);
  return true;
}

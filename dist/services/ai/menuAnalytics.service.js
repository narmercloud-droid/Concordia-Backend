...
export class MenuAnalyticsService {
     ...
     */
    static async updateMenuItemStats(order) {
     ...
     */
    static async calculatePopularity(itemId) {
     ...
     */
    static async getTopItems(branchId, limit = 10) {
     ...
     */
    static async getMenuAnalytics(itemId) {

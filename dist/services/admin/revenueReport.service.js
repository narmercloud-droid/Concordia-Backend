...
export function isCountableRevenueOrder(order) {
    if (CANCELLED_STATUSES.includes(order.status))
        return false;
    if (isCashMethod(order.paymentMethod))
        return true;
...
export async function getRevenueReport(params) {
    ...
    return {
        ...
        legalNote: "Umsatzbericht für interne Buchführung. Barumsätze bei Übergabe; Online-Zahlungen bei Zahlungsstatus „paid“. Alle Beträge in EUR."
    };
}

...
import { isKnownGermanPostalCode, reverseGeocode, resolveCityFromPostalCode, suggestAddresses } from "../../services/geo/geocode.service.js";
...
import { generateBranchOrderQrPng } from "../../utils/qrGenerator.js";
    ...
    const suggestions = await suggestAddresses(q, {
        ...
        lat: Number.isFinite(queryLat) && queryLat !== 0
            ...
            : Number.isFinite(configLat) && configLat !== 0
                ? configLat
                : undefined,
        lng: Number.isFinite(queryLng) && queryLng !== 0
            ? queryLng
            : Number.isFinite(configLng) && configLng !== 0
                ? configLng
                : undefined
    });
    const filtered = allowedPostcodes.size > 0 &&

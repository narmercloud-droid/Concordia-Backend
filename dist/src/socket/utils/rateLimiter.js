 ...
 */
export const initSocketRateLimit = (socket, config = DEFAULT_CONFIG) => {
 ...
 */
export const checkRateLimit = (socket, config = DEFAULT_CONFIG) => {
    const now = Date.now();
 ...
 */
export const getRateLimitStats = (socket) => {
 ...
 */
export const createRateLimitMiddleware = (config = DEFAULT_CONFIG) => {
    return (socket, next) => {
 ...
 */
export const withRateLimit = (socket, event, handler, config = DEFAULT_CONFIG) => {
 ...
 */
export const cleanupIPRateLimit = (clientIP) => {
    ipLimits.delete(clientIP);
};
/**
 * Cleanup all rate limit data for a branch
 */
export const cleanupBranchRateLimit = (branchId) => {

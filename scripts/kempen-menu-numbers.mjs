...
export const MENU_NUMBER_ENTRIES = [
  ...
  { number: "06", match: "Pizza Tonno e Cipolla" },
  { number: "07", match: "Pizza Tonno" },
  { number: "08", match: "Pizza Spinaci" },
  { number: "09", match: "Pizza Scampi" },
  { number: "10", match: "Pizza Frutti di Mare" },
  { number: "11", match: "Pizza Sucuk" },
  ...
  { number: "24", match: "Pizza Hähnchen" },
  { number: "25", match: "Pizza Chef" },
  { number: "26", match: "Pizza Italia" },
  { number: "27", match: "Pizza Enzo" },
  // Pizzen 28–40
  ...
  { number: "47", match: "Pizzabrötchen mit Thunfisch, Zwiebeln" },
  { number: "48", match: "Pizzabrötchen mit Thunfisch" },
  { number: "49", match: "Pizzabrötchen mit Salami" },
  { number: "50", match: "Pizzabrötchen mit Hinterschinken" },
  { number: "51", match: "Pizzabrötchen mit Bolognese" },
  { number: "52", match: "Pizzabrötchen mit Sucuk" },
  { number: "53", match: "Pizzabrötchen mit Spinat" },
  ...
  { number: "82", match: "Bratwurst" },
  { number: "83", match: "Currywurst" },
  { number: "84", match: "Bratrolle Spezial" },
  { number: "85", match: "Bratrolle" },
  { number: "86", match: "Rindfleischkrokette" },
  { number: "87", match: "Chicken Nuggets" },
  { number: "88", match: "Chicken Wings" },
  { number: "89", match: "Mozzarella Sticks" },
  { number: "90", match: "Kartoffel-Kroketten" },
  { number: "91", match: "Mayonnaise" },
  { number: "92", match: "Ketchup" },
  // Pasta 100–110
  ...
  { number: "163", match: "Baguette mit Thunfisch und Ei" },
  { number: "164", match: "Baguette mit Sucuk und Ei" },
  { number: "165", match: "Baguette mit Mozzarella" },
  { number: "166", match: "Baguette mit Thunfisch" },
  { number: "167", match: "Baguette mit Sucuk" }
];
